...
def generate_response(input_text):
    ...
    Provide samples of the transcriptions that are important to your query. Respond in the following structure: 1. provide simple and clear explanation to the user query. 2. ask highly challenging questions based on the query to test user's understanding. 3. based on their responses, give them relevant timestamps from the video to rewatch.
    """
...
def chat_input():
    user_input = st.chat_input("Ask me anything about uploaded lecture videos.")
