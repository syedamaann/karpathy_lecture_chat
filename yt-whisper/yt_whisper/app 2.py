...
def process_video(video_url: str) -> dict[str, str]:
    ...
    try:
        # Use OAuth to bypass some restrictions
        yt_handler = YouTube(video_url, use_oauth=True, allow_oauth_cache=True)
    ...
    try:
        ...
        st.error(f"Video is unavailable. This could be due to regional restrictions, age restrictions, or the video being private/deleted.", icon="🚨")
